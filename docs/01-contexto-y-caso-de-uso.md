...
- **Iniciativa de Documentación con IA ante el Vacío Escrito:** En IndraMind no existía documentación formalizada por escrito (la transferencia de conocimiento se reducía a reuniones verbales en Teams para justificar la formación), una carencia comprensible por la juventud del proyecto pero que el profesional se encargó de solventar proactivamente mediante la redacción y estructuración de documentación técnica en Confluence y Jira acelerada con herramientas de Inteligencia Artificial.
