...
3. **Multi-Entorno con Kustomize:**
   - Base común inmutable en `kustomize/base/`.
   - Variaciones parametrizadas por entorno en `kustomize/overlays/dev/` y `kustomize/overlays/prod/` (cuotas de memoria, réplicas, perfiles de recursos).
...
│   └── scsp-application.yaml             # Manifiesto maestro ArgoCD con finalizer
├── nexus/
...
│   └── overlays/
│       ├── dev/                          # Patch de réplicas y recursos dev
